...
$route['*']['/init_session'] = array('MainController', 'init_session');
$route['*']['/home'] = array('MainController', 'home');
$route['*']['/logout'] = array('MainController', 'logout');

//Web services
$route['*']['/error'] = array('ErrorController', 'index');
$route['*']['/create/:logintype/:usertype'] = array('UsersController','create_user');
$route['*']['/login'] = array('UsersController','login');
$route['*']['/check/:username'] = array('UsersController','user_exists');
$route['*']['/subscribe'] = array('SubscriptionController','subscribe');
$route['*']['/subscriptions/get'] = array('SubscriptionController','subscriptions');
$route['*']['/removesubscription'] = array('SubscriptionController','remove_subscription');
$route['*']['/updatelocation'] = array('UpdatesController','update_location');
$route['*']['/authentication']= array('UsersController','login');
$route['*']['/push/update'] = array('UpdatesController', 'publish');

// services 
//posting an update
//pushing updates to nearby subscribers
